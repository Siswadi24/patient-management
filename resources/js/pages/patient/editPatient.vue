...
<template>
    <div>
        ...
        <Button @click="openEditDialog" size="small" class="justify-start border-yellow-600 bg-yellow-600 py-2 text-sm text-white hover:bg-yellow-700">
                ...
                <form @submit.prevent="handleSubmit">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div class="flex flex-col">
                                ...
                                <InputText
                                    ...
                                    v-model="form.emergency_full_name"
                                    class="flex-auto"
                                    autocomplete="off"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div class="flex flex-col">
                                <label for="communication_barrier" class="font-semibold">Hambatan Komunikasi (Opsional)</label>
                                <InputText
                                    id="communication_barrier"
                                    v-model="form.communication_barrier"
                                    class="flex-auto"
                                    autocomplete="off"
