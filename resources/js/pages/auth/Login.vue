...
<template>
    ...
    <div class="min-h-screen flex">
        <div class="flex-1 flex flex-col justify-center px-8 py-12 lg:px-16 xl:px-20 bg-white dark:bg-gray-900">
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">Masukkan email dan kata sandi Anda untuk mengakses akun
                        Anda.</p>
                </div>

                <div v-if="status"
                    class="mb-6 p-4 bg-green-50 dark:bg-green-900/50 border border-green-200 dark:border-green-700 rounded-md">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <Input id="password" type="password" required autocomplete="current-password"
                            v-model="form.password" placeholder="Sellostore." :class="[
        ...
        <div
            class="hidden lg:flex lg:flex-1 bg-gradient-to-br from-green-600 to-green-800 dark:from-green-700 dark:to-green-900 relative overflow-hidden">
            <div class="flex flex-col justify-center px-12 xl:px-16 text-white relative z-10">
                ...
                <p class="text-green-100 dark:text-green-200 text-lg mb-8">Daftar sekarang untuk mulai mencatat,
                    melacak, dan menganalisis pasien Anda dengan sistem yang rapi dan terorganisir.</p>

                <div
                    class="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/20 dark:border-white/10">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-green-900/50 dark:from-green-950/70 to-transparent">
            </div>
            <div
                class="absolute top-0 right-0 w-96 h-96 bg-white/5 dark:bg-white/3 rounded-full -translate-y-48 translate-x-48">
            </div>
            <div
                class="absolute bottom-0 left-0 w-64 h-64 bg-white/5 dark:bg-white/3 rounded-full translate-y-32 -translate-x-32">
            </div>
        </div>
    </div>
</template>
