<template>
    <div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
        <div class="w-full max-w-md space-y-8">
            ...
            <div>
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-white">Verifikasi Login</h2>
            ...
            <form @submit.prevent="submitOtp" class="mt-8 space-y-6">
                ...
                <div class="text-center">
                    <button
                        ...
                        class="cursor-pointer text-sm text-indigo-600 hover:text-indigo-500 disabled:opacity-50 dark:text-indigo-400 dark:hover:text-indigo-300"
                    >
...
const submitOtp = (): void => {
    ...
    form.post(route('login.otp.verify.post'), {
        onFinish: () => {
...
const resendOtp = (): void => {
    ...
    useForm({ email: props.email }).post(route('login.otp.resend'), {
        onSuccess: () => {
