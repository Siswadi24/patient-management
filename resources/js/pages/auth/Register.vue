        ...
        <div class="flex flex-1 flex-col justify-center bg-white px-8 py-12 lg:px-16 xl:px-20 dark:bg-gray-900">
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">Masukkan detail Anda di bawah ini untuk membuat akun
                        baru.</p>
                </div>

                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        <Label for="name" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Full
                            Name</Label>
                    ...
                    <div>
                        ...
                        <Input id="password" type="password" required autocomplete="new-password"
                            v-model="form.password" placeholder="Create a strong password" :class="[
                                'w-full rounded-lg border bg-white px-4 py-3 text-gray-900 placeholder-gray-500 focus:ring-2 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400',
                        ...
                        <div v-if="form.password" class="mt-2 space-y-1">
                            <div class="flex items-center space-x-2 text-xs">
                                ...
                                <span
                                    :class="passwordValidation.hasNumber ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                                    Mengandung angka
                                </span>
                            </div>
                            <div class="flex items-center space-x-2 text-xs">
                                ...
                                <X v-else class="h-3 w-3 text-red-500" />
                                <span
                                    :class="passwordValidation.hasUppercase ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                            ...
                            <div class="flex items-center space-x-2 text-xs">
                                ...
                                <X v-else class="h-3 w-3 text-red-500" />
                                <span
                                    :class="passwordValidation.hasLowercase ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                    ...
                    <div>
                        ...
                        <Input id="password_confirmation" type="password" required autocomplete="new-password"
                            v-model="form.password_confirmation" placeholder="Confirm your password" :class="[
                                'w-full rounded-lg border bg-white px-4 py-3 text-gray-900 placeholder-gray-500 focus:ring-2 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400',
                        ...
                        <div v-if="form.password_confirmation" class="mt-2">
                            <div class="flex items-center space-x-2 text-xs">
                                <Check v-if="form.password_confirmation === form.password"
                                    class="h-3 w-3 text-green-500" />
                                <X v-else class="h-3 w-3 text-red-500" />
                                <span
                                    :class="form.password_confirmation === form.password ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
                                    Password sesuai
                                </span>
                            </div>
                        </div>
                    ...
                    <Button type="submit"
                        class="w-full rounded-lg bg-blue-600 px-4 py-3 font-medium text-white transition-colors duration-200 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                        :disabled="form.processing || (form.password && !passwordValidation.isValid) || (form.password_confirmation && form.password_confirmation !== form.password)">
        ...
        <div
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 text-white xl:px-16">
                ...
                <p class="mb-8 text-lg text-green-100 dark:text-green-200">
                    Daftar sekarang untuk mulai mencatat, melacak, dan menganalisis pasien Anda dengan sistem secara
                    otomatis dan terorganisir.
                </p>
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-200 dark:text-green-300">Catat dan lacak semua pasien dengan
                                mudah.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-200 dark:text-green-300">Dapatkan insight jelas melalui grafik
                                & laporan real-time.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-200 dark:text-green-300">Data kesehatan Anda terlindungi dengan
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-green-900/50 to-transparent dark:from-green-950/70">
            </div>
            <div
                class="absolute top-0 right-0 h-96 w-96 translate-x-48 -translate-y-48 rounded-full bg-white/5 dark:bg-white/3">
            </div>
            <div
                class="absolute bottom-0 left-0 h-64 w-64 -translate-x-32 translate-y-32 rounded-full bg-white/5 dark:bg-white/3">
            </div>
        </div>
    </div>
</template>
