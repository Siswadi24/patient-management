<template>
    <div class="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
        <div class="w-full max-w-md space-y-8">
            ...
            <div>
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-white">Verifikasi Email</h2>
...
const submitOtp = (): void => {
    ...
    form.post(route('otp.verify.post'), {
        onFinish: () => {
...
const resendOtp = (): void => {
    ...
    useForm({ email: props.email }).post(route('otp.resend'), {
        onSuccess: () => {
